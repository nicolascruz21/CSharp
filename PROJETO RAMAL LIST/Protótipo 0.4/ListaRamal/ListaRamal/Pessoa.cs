...
class Pessoa
{
    ...
    public void GerenciarRamal()
    {
        ...
        Console.WriteLine("1 - Adicionar Ramal");
        Console.WriteLine("2 - Remover Ramal");
        Console.WriteLine("3 - Editar Ramal");
    ...
    public void ExibirGruposCaptura()
    {
        ...
        else
        {
            ...
            if (opcaoGrupo >= 1 && opcaoGrupo <= 9)
            {
                ...
                Console.WriteLine("*****************************************");
                Console.WriteLine("\nRamais que podem ser capturados por outros grupos:");
